...
<template>
	<div
		ref="divFloat"
		class="div-flutuante"
		v-show="userLoggedImpl.visibleUserLogged"
	>
		<article>
			<header>
				<div style="display: flex; justify-content: center">
					<div style="display: relative">
						<img
							...
							:src="userLoggedImpl.userLoggedData.currentImage"
						/>
				...
				<p class="h6">
					{{ userLoggedImpl.userLoggedData.userLogged?.first_name }}
				</p>
			</header>
			...
			<table>
				<tbody>
					<tr>
						...
						<td>
							{{
								userLoggedImpl.userLoggedData.userLogged?.getNameComplete()
							}}
						</td>
					</tr>
					<tr>
						...
						<td>
							{{
								userLoggedImpl.userLoggedData.userLogged?.getTextResponsible()
							}}
						</td>
					</tr>
				...
				<ToolButton @click="singOut">
					...
					>
						<g id="_110_log-out-03" data-name="110 log-out-03">
							<path
								d="M8.88,22.71l-5.29-5.3a2,2,0,0,1,0-2.82l5.29-5.3,1.41,1.42L5,16l5.29,5.29Z"
							/>
							<rect x="4.59" y="15" width="14" height="2" />
							<path
								d="M16,29V27A11,11,0,0,0,16,5V3a13,13,0,0,1,0,26Z"
							/>
						</g>
					</svg>
					Sair
