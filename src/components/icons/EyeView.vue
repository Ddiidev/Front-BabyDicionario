    ...
    <div style="width: 35px; height: 100%;">
        <svg enable-background="new 0 0 32 32" id="Editable-line" version="1.1" viewBox="0 0 32 32" xml:space="preserve"
            ...
            <path
                ...
                fill="none" id="XMLID_10_" stroke="#8d5a53" stroke-linecap="round" stroke-linejoin="round"
                stroke-miterlimit="10" stroke-width="2.5" />
            <circle cx="16" cy="16" fill="none" id="XMLID_12_" r="5" stroke="#8d5a53" stroke-linecap="round"
