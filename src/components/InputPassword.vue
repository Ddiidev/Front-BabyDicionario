...
<template>
	<fieldset role="group">
		<input
			:type="inputPasswordData.visiblePass ? 'text' : 'password'"
			:placeholder="inputPasswordData.placeholder"
			autocomplete="Password"
			v-model="inputPasswordData.contentPassword"
			:aria-invalid="validatedPassword"
	...
	<small
		v-if="inputPasswordData.passwordValidated != undefined"
		id="valid-pass"
	>
...
export default defineComponent({
	...
	methods: {
		switchView() {
			this.inputPasswordData!.visiblePass =
				!this.inputPasswordData.visiblePass;
		},
	},
});
